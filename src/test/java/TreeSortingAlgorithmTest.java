...
import main.java.comparisonBasedSortingAlgorithms.TreeSortingAlgorithm;

public class TreeSortingAlgorithmTest {
	private static TreeSortingAlgorithm<Integer> treeSortingAlgorithm;
	...
	public static void init() { 
		System.out.println("###   Tree Sorting Algorithm Test   ###");
		inputArray = new Integer[] {34, -3, 4, 25, 60, -77, 91, 0, -59};
		treeSortingAlgorithm = new TreeSortingAlgorithm<Integer>();
	}
