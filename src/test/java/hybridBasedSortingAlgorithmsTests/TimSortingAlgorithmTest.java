...
import hybridBasedSortingAlgorithms.TimSortingAlgorithm;

public class TimSortingAlgorithmTest {
	private static TimSortingAlgorithm<Integer> timSortingAlgorithm;
	...
	public static void init() { 
		System.out.println("###   Tim Sorting Algorithm Test   ###");
		inputArray = new Integer[] {34, -3, 4, 25, 60, -77, 91, 0, -59};
		timSortingAlgorithm = new TimSortingAlgorithm<Integer>();
	}
